...
public class GrapplingInventoryClick implements Listener {
        ...
        if (plugin.getConfiguration().getBoolean("GRAPPLING_HOOK.ENABLED")) {
            ...
            try {
                if ((event.getCurrentItem() != null) &&
                        ...
                        (event.getCurrentItem().getItemMeta().getDisplayName().equalsIgnoreCase(titleHook)) &&
                        plugin.getConfiguration().getBoolean("GRAPPLING_HOOK.CONFIGURATION.MOVE_DISABLE")) {
