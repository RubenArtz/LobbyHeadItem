...
public class GrapplingDropItem implements Listener {
        ...
        if (plugin.getConfiguration().getBoolean("GRAPPLING_HOOK.ENABLED")) {
            ...
            try {
                if ((itemStack.hasItemMeta()) &&
                        (getDisplayName.equalsIgnoreCase(titleHook)) &&
                        plugin.getConfiguration().getBoolean("GRAPPLING_HOOK.CONFIGURATION.NO_DROP_ITEM")) {
